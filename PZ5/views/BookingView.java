...
import PZ5.presenters.View;
import PZ5.presenters.ViewObserver;
...
public class BookingView implements View {
     ...
     */
    @Override
    public void showChangeReservationStatus(int reservationNo) {
        if (reservationNo > 0){
            System.out.printf("Столик снят сбронирования. Номер брони: #%d\n", reservationNo);
        }
        else {
